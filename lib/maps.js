...
/*function bindDataLayerListeners(dataLayer) {
    dataLayer.addListener('addfeature', saveDataToLocalStorage);
    dataLayer.addListener('removefeature', saveDataToLocalStorage);
    dataLayer.addListener('setgeometry', saveDataToLocalStorage);
}*/
...
maps.groupAreasByProperty = function(property) {
  if (property != undefined && property != '' && !document.getElementById('legend')) {
    maps.buildLegend();
  }
