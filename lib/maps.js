...
maps.setupInfoWindow = function (options) {
  ...
  if ('hover' in options && (options['hover'] == true || options['hover'] == false)) hover = options['hover'];
  if ('properties' in options && options['properties'] != undefined) propertiesToDisplay = options['properties'];
  if ('editable' in options && (options['editable'] == true || options['editable'] == false)) editable = options['editable'];
