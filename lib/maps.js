...
maps.generateLegendContent = function (col, propContent, colToggable) {
  ...
  if(colToggable) {
    ...
    button.innerHTML = "<p>" + "<button id='changeColours'> Vaheta värve </button>" + "</p>";
    button.style.display = "inline-block";
    container.appendChild(button);
    legend.appendChild(container);
    maps.toggleColorblind('changeColours');
  }
  else {
    legend.appendChild(container);
  }
